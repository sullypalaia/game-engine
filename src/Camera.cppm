...
/**
 * \brief projection and view matrices that will be inside a uniform buffer, accessible by any glsl shader
*/
 ...
 * the camera types will be components in the future to respect data-oriented design principles
*/
